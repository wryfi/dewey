# -*- coding: utf-8 -*-
# Generated by Django 1.9.6 on 2016-06-08 23:04
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('permissions', django_enumfield.db.fields.EnumField(default=1, enum=environments.SafePermissions)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(help_text='dotted-path key for this secret', max_length=256, unique=True)),
